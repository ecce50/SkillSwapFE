...
function ClassSessions({classes}) {
  ...
  useEffect(() => {
    const fetchSessions = async () => {
      ...
      try {
        ...
        const sessRes = await axios.get(`http://localhost:5005/session/sessions?classId=${classId}`,
          {
            headers: {
    ...
    return (
     ...
     We can reuse the current logic from the TeacherSkills component */
      <div>
        <h2>ClassSessions</h2>
